...
public class AttachmentObject  extends SalesforceObject {

    public static final String ATTACHMENT_TITLE = "Title";
    public static final String ATTACHMENT_ID = "LinkedEntityId";
    public static final String CONTENT_DOCUMENT_ID = "ContentDocumentId";
    public static final String CONTENT_DOCUMENTFILE_TYPE = "FileType";
     ...
     * @param data Raw data.
     */
    public AttachmentObject(JSONObject data) {
        super(data);
        objectType = "attachments";
        objectId = data.optString(CONTENT_DOCUMENT_ID);
        name = data.optString(ATTACHMENT_TITLE);
    ...
    public String getAttachmentTitle() {
        return sanitizeText(rawData.optJSONObject("ContentDocument").optString(ATTACHMENT_TITLE));
    }

    public String getAttachmentId() {
        return sanitizeText(rawData.optString(ATTACHMENT_ID));
    }

    public String getContentDocumentId() {
        return sanitizeText(rawData.optString(CONTENT_DOCUMENT_ID));
    }

    public String getContentDocumentfileType() {
        return sanitizeText(rawData.optJSONObject("ContentDocument").optString(CONTENT_DOCUMENTFILE_TYPE));
    }
